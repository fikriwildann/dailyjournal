...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
      <div class="container">
        <a class="navbar-brand" href="#">WILLI.STORE</a>
        <button
        ...
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          ...
          <div>
            ...
            <h4 class="lead display-6">
              Quality products, exceptional service, unforgettable experiences.
            </h4>
            <h6>
...
<!-- article end -->
      ...
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          ...
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.15487</h3>
            <h1 class="fw-bold">Fikri Wildan Ariyananda</h1>
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        <a href="https://www.instagram.com/fikriwildann"
          ><i class="bi bi-instagram h2 p-2"></i
        ></a>
        <a href="https://twitter.com/fikriwildann"
          ><i class="bi bi-twitter h2 p-2"></i
        ></a>
        <a href="https://wa.me/+6281325178060"
          ><i class="bi bi-whatsapp h2 p-2"></i
        ></a>
      </div>
      <div>Fikri Wildan Ariyananda &copy; 2023</div>
    </footer>
    <!-- footer end -->
